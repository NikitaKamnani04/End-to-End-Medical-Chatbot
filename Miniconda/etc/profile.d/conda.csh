setenv CONDA_EXE `cygpath C:\End-to-End-Medical-Chatbot\Miniconda\Scripts\conda.exe`
setenv _CONDA_ROOT `cygpath C:\End-to-End-Medical-Chatbot\Miniconda`
setenv _CONDA_EXE `cygpath C:\End-to-End-Medical-Chatbot\Miniconda\Scripts\conda.exe`
setenv CONDA_PYTHON_EXE `cygpath C:\End-to-End-Medical-Chatbot\Miniconda\python.exe`
