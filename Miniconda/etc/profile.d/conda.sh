export CONDA_EXE="$(cygpath 'C:\End-to-End-Medical-Chatbot\Miniconda\Scripts\conda.exe')"
export _CE_M=''
export _CE_CONDA=''
export CONDA_PYTHON_EXE="$(cygpath 'C:\End-to-End-Medical-Chatbot\Miniconda\python.exe')"
