set -gx CONDA_EXE (cygpath "C:\End-to-End-Medical-Chatbot\Miniconda\Scripts\conda.exe")
set _CONDA_ROOT (cygpath "C:\End-to-End-Medical-Chatbot\Miniconda")
set _CONDA_EXE (cygpath "C:\End-to-End-Medical-Chatbot\Miniconda\Scripts\conda.exe")
set -gx CONDA_PYTHON_EXE (cygpath "C:\End-to-End-Medical-Chatbot\Miniconda\python.exe")
