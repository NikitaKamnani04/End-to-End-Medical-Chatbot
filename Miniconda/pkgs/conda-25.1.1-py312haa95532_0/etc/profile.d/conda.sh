export CONDA_EXE="$(cygpath 'C:\b\abs_12ybmrg1d4\croot\conda_1738168389704\_h_env\Scripts\conda.exe')"
export _CE_M=''
export _CE_CONDA=''
export CONDA_PYTHON_EXE="$(cygpath 'C:\b\abs_12ybmrg1d4\croot\conda_1738168389704\_h_env\python.exe')"
